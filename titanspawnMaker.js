...
fightCompute = Math.floor(((playerLevelVar-0.5)*4)*(playerNumberVar)*(1.5-(fightDifficultyVar/4)))
...
if (legendChoice === "4") {
     ...
     abilityOne += 3 + legendaryBonus2//1 + legendaryBonus2
     skillAbilityOne =  3//1
     stuntBonus += 0//1
}
...
myWindow.document.write("</BODY>")
myWindow.document.write("</HTML>")
var myWindow2 = window.open("", "_blank","width=500, height=500");
