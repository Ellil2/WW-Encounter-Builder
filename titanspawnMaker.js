...
enemyType = "Group2"   
if(document.getElementById("Aten").value){decision(document.getElementById("Aten").value)}
else{decision(fightCompute/2,0)}
enemyType = "Group2"
if(document.getElementById("Fenrir").value){decision(document.getElementById("Fenrir").value)}
else{decision(fightCompute/2,0)}
}     
